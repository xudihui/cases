...
function insertSwfV2(elm,url,width,height,flashvars,params,version){
	...
	if(isVer) {
		...
		document.getElementById(elm).innerHTML='<div id="noflash" ><p>���������flash����汾����'+version+';�����������µ�Flash���--><a href="http://get.adobe.com/flashplayer/" target="_blank" title="�������µ�Flash���"><img src="http://ossweb-img.qq.com/images/xy/web200907/images/flashLogo.gif" align="absmiddle" target="_blank" />�������</a></p> </div>'
	}
	*/
}
